        ...
        return (
          <div key={index} className="py-5 px-6">
            ...
            >
              ...
              <span className="shrink-0 mt-0.5 w-6 h-6 rounded-[4px] bg-brand-orange/10 flex items-center justify-center transition-colors duration-200 group-hover:bg-brand-orange/20">
                {isOpen ? (
