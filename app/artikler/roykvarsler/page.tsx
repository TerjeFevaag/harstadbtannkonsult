...
export const metadata: Metadata = {
  title: 'Riktig røykvarsler redder liv | Harstad Brannkonsult',
  description:
            ...
            <div className="prose prose-lg max-w-none text-brand-darkgray">
              ...
              <ScrollReveal>
                <div className="border border-brand-gray rounded-[10px] p-6 mb-8">
                  <h3 className="font-bold text-brand-black text-lg mb-3">Anbefaling fra Harstad Brannkonsult</h3>
              ...
              <ScrollReveal>
                ...
                <p className="leading-relaxed">
                  ...
                  <Link href="/kontakt-oss" className="text-brand-orange font-bold hover:underline">
                    Ta kontakt med Harstad Brannkonsult
                  </Link>{' '}
